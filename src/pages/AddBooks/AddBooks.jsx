...
const AddBooks = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!bookData.bookTitle || !bookData.bookImg || !bookData.authorName || !bookData.authorEmail || !bookData.shortDescription || !bookData.bookContent || !bookData.category || !bookData.quantity) {
        ...
        // Send data to the DB
        axios.post('http://localhost:3000/addBooks', bookData)
            .then(res => {
                if (res.data.insertedId) {
                    ...
                    Toast.fire({
                        icon: "success",
                        title: "Your book successfully published!"
                    });
                    form.reset();
                } else {
